...
<div class="formPanel">
	...
	<div><input type="text" id="file_ext" name="file_ext" value="<?= $file_ext ?>" /></div>
</div>
<div class="formPanel">
...
<div class="formPanel">
	<label for="tags">Add Tags (Comma Seperated)</label>
...
<div class='formBtnsPanel'>
	...
	<input type="submit" value="Update Code Snippet" />
</div>
<?= form_close(); ?>
<? tpl_footer(); ?>
